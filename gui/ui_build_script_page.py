...
class Ui_BuildScriptPage(object):
    def setupUi(self, BuildScriptPage):
        ...
        BuildScriptPage.resize(800, 600)
        ...
        self.stackedWidget = QStackedWidget(BuildScriptPage)
        ...
        self.skipTechButton = QPushButton(self.initialChoicePage)
        self.skipTechButton.setObjectName(u"skipTechButton")
        self.skipTechButton.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.horizontalLayout.addWidget(self.skipTechButton)
        ...
        self.standardTextEdit.setReadOnly(False)
        ...
        self.pmInputTabWidget.setCurrentIndex(0)
    ...
    def retranslateUi(self, BuildScriptPage):
        ...
        self.instructionLabel.setText(QCoreApplication.translate("BuildScriptPage", u"Select a technology to generate a build script, or provide your own guidelines.", None))
        self.skipTechButton.setText(QCoreApplication.translate("BuildScriptPage", u"Skip this Technology", None))
        self.aiProposedButton.setText(QCoreApplication.translate("BuildScriptPage", u"Generate with AI Proposal", None))
        self.pmGuidedButton.setText(QCoreApplication.translate("BuildScriptPage", u"Use PM Guidelines / Manual Script", None))
        self.pmDefineHeaderLabel.setText(QCoreApplication.translate("BuildScriptPage", u"Define Guidelines for [Technology] Build Script", None))
        self.pmInputTabWidget.setTabText(self.pmInputTabWidget.indexOf(self.textInputTab), QCoreApplication.translate("BuildScriptPage", u"Enter Manual Build Script", None))
        self.browseFilesButton.setText(QCoreApplication.translate("BuildScriptPage", u"Browse...", None))
        self.pmInputTabWidget.setTabText(self.pmInputTabWidget.indexOf(self.uploadTab), QCoreApplication.translate("BuildScriptPage", u"Upload Build Script(s)", None))
        self.cancelButton_1.setText(QCoreApplication.translate("BuildScriptPage", u"Cancel", None))
        self.generateFromGuidelinesButton.setText(QCoreApplication.translate("BuildScriptPage", u"Use This Content & Generate", None))
        self.reviewHeaderLabel.setText(QCoreApplication.translate("BuildScriptPage", u"Review Build Script for [Technology]", None))
        self.reviewTabWidget.setTabText(self.reviewTabWidget.indexOf(self.specDraftTab), QCoreApplication.translate("BuildScriptPage", u"Script Draft", None))
        self.reviewTabWidget.setTabText(self.reviewTabWidget.indexOf(self.aiAnalysisTab), QCoreApplication.translate("BuildScriptPage", u"AI Analysis", None))
        self.feedbackLabel.setText(QCoreApplication.translate("BuildScriptPage", u"Provide feedback (this will not run, for consistency only).", None))
        self.reviewTabWidget.setTabText(self.reviewTabWidget.indexOf(self.feedbackTab), QCoreApplication.translate("BuildScriptPage", u"Feedback", None))
        self.cancelButton_2.setText(QCoreApplication.translate("BuildScriptPage", u"Cancel", None))
        self.refineButton.setText(QCoreApplication.translate("BuildScriptPage", u"Refine", None))
        self.approveButton.setText(QCoreApplication.translate("BuildScriptPage", u"Approve Script", None))
        self.processingLabel.setText(QCoreApplication.translate("BuildScriptPage", u"Processing... Please wait.", None))
    # retranslateUi
