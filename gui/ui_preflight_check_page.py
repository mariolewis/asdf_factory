...
class Ui_PreflightCheckPage(object):
    ...
    def retranslateUi(self, PreflightCheckPage):
        ...
        self.continueButton.setText(QCoreApplication.translate("PreflightCheckPage", u"Continue Project &&&& Re-sync State", None))
        self.continueLabel.setText(QCoreApplication.translate("PreflightCheckPage", u"(Primary option: Commits your manual fixes and synchronizes the project's internal state before resuming. You will be asked to confirm the scope of your changes.)", None))
