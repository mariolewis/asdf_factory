...
#endif // QT_CONFIG(tooltip)
        self.actionManage_CRs_Bugs.setText(QCoreApplication.translate("MainWindow", u"Change && Bug Management", None))
#if QT_CONFIG(tooltip)
        self.actionManage_CRs_Bugs.setToolTip(QCoreApplication.translate("MainWindow", u"View and manage the CR/Bug register", None))
#endif // QT_CONFIG(tooltip)
