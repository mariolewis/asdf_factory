...
class Ui_TestEnvPage(object):
    def setupUi(self, TestEnvPage):
        ...
        self.exportButton = QPushButton(self.checklistPage)
        ...
        self.previousButton = QPushButton(self.checklistPage)
    ...
    def retranslateUi(self, TestEnvPage):
        ...
        self.backendCommandLabel.setText(QCoreApplication.translate("TestEnvPage", u"Backend Unit/Regression Test Command:", None))
